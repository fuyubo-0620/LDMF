...
class Fusion_loss(nn.Module):
    def __init__(self,lambda1=10,lambda2=40,lambda3=40):
        ...
        # print(1)
    def forward(self, image_A, image_B, image_fused):
        loss_SSIM     =self.lambda1*(1 - self.L_SSIM(image_A, image_B, image_fused))
        loss_gradient =self.lambda2*self.L_Grad(image_A, image_B, image_fused)
        loss_l1       =self.lambda3*self.L_Inten(image_A, image_B, image_fused)
